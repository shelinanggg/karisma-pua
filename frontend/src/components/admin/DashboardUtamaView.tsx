      ...
      {displayStatistics && (
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
            {/* Golongan */}
            {displayStatistics.golongan && displayStatistics.golongan.length > 0 && (
              <Card>
            ...
            {/* Pendidikan */}
            {displayStatistics.pendidikan && displayStatistics.pendidikan.length > 0 && (
              <Card>
                <CardHeader className="pb-3">
                  <CardDescription className="flex items-center gap-2">
            ...
            {/* Fungsional */}
            {displayStatistics.fungsional && displayStatistics.fungsional.length > 0 && (
              <Card>
                <CardHeader className="pb-3">
                  <CardDescription className="flex items-center gap-2">
            ...
            {/* Jabatan */}
            {displayStatistics.jabatan && displayStatistics.jabatan.length > 0 && (
              <Card>
                <CardHeader className="pb-3">
                  <CardDescription className="flex items-center gap-2">
