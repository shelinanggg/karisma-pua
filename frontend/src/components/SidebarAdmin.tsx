import { BellRing, BriefcaseBusiness, Building2, ServerCog, User, Settings, ChevronRight, LayoutDashboard, FolderKanban, ListChecks, ClipboardList, CalendarDays } from 'lucide-react';
...
const navItems = [
  ...
  { id: 'master-jabatan', label: 'Master Jabatan', icon: BriefcaseBusiness },
