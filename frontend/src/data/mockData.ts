...
export const mockProjects: Project[] = [
  {
    id: 'p1',
    name: 'Upload Buku Pedoman Kinerja Triwulan IV',
    client: 'Bidang Perencanaan',
    status: 'Active',
    assignedTeam: ['Sarah Johnson', 'Emily Davis'],
    workspace: 'Unit Perencanaan Kinerja',
    progress: 65,
    deadline: '2025-11-15',
    objectives: 'Menyusun dan mengunggah buku pedoman kinerja triwulan IV sebagai acuan pelaksanaan SKP di seluruh unit kerja.',
    activeTasks: 8,
    completedTasks: 12,
  },
  {
    id: 'p2',
    name: 'Upload Buku Standar Penilaian SKP',
    client: 'Bidang SDM Aparatur',
    status: 'Active',
    assignedTeam: ['Michael Chen', 'James Wilson'],
    workspace: 'Unit Pengembangan SDM',
    progress: 40,
    deadline: '2025-12-01',
    objectives: 'Menetapkan standar penilaian SKP terbaru dan memastikan buku pedoman penilaian terunggah sesuai target periode berjalan.',
    activeTasks: 15,
    completedTasks: 8,
  },
  {
    id: 'p3',
    name: 'Upload Buku Monitoring Capaian Kegiatan',
    client: 'Bidang Evaluasi Kinerja',
    status: 'Paused',
    assignedTeam: ['Sarah Johnson'],
    workspace: 'Unit Monitoring Evaluasi',
    progress: 30,
    deadline: '2025-11-30',
    objectives: 'Menghimpun dokumen monitoring kegiatan bulanan dan mengunggah buku capaian kegiatan untuk kebutuhan evaluasi pimpinan.',
    activeTasks: 5,
    completedTasks: 3,
  },
  {
    id: 'p4',
    name: 'Upload Buku Laporan Capaian SKP Bulanan',
    client: 'Bidang Pelaporan',
    status: 'Completed',
    assignedTeam: ['Emily Davis', 'James Wilson'],
    workspace: 'Unit Pelaporan Kinerja',
    progress: 100,
    deadline: '2025-10-05',
    objectives: 'Menyelesaikan kompilasi dan unggah buku laporan capaian SKP bulanan sebagai dokumen resmi pelaporan organisasi.',
    activeTasks: 0,
    completedTasks: 20,
  },
  {
    id: 'p5',
    name: 'Upload Buku Rencana Kerja dan SKP Tahunan',
    client: 'Bidang Perencanaan Program',
    status: 'Active',
    assignedTeam: ['Michael Chen', 'Emily Davis', 'James Wilson'],
    workspace: 'Unit Perencanaan Program',
    progress: 55,
    deadline: '2025-11-20',
    objectives: 'Memfinalisasi dan mengunggah buku rencana kerja tahunan beserta target SKP untuk sinkronisasi lintas bidang.',
    activeTasks: 12,
    completedTasks: 10,
  },
];
